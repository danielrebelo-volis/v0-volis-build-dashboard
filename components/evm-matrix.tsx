  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative w-[calc(100%-80px)] h-[calc(100%-80px)]">
        ...
        <div className="absolute -left-5 top-1/2 -translate-y-1/2 text-xs font-semibold text-warning flex items-center gap-1.5">
          <span>50%</span>
      ...
      {/* Y-Axis Label */}
      <div className="absolute left-0.5 top-1/2 -translate-y-1/2 -translate-x-12 origin-center -rotate-90">
