...
const projects: Project[] = [
  ...
  { id: "PRJ-001", name: "Metro Tower", delay: -35, industrialCost: 95, budget: "€24.5M", trend: "up", category: "Construção Civil", region: "north", week: "week-1", weekData: { "week-1": { delay: -35, industrialCost: 95 }, "week-2": { delay: -30, industrialCost: 92 }, "week-3": { delay: -25, industrialCost: 88 }, "week-4": { delay: -20, industrialCost: 85 } } },
  { id: "PRJ-011", name: "Urban Renewal Center", delay: -20, industrialCost: 92, budget: "€67.3M", trend: "up", category: "Infraestruturas Rodoviárias", region: "north", week: "week-2", weekData: { "week-1": { delay: -15, industrialCost: 89 }, "week-2": { delay: -20, industrialCost: 92 }, "week-3": { delay: -25, industrialCost: 94 }, "week-4": { delay: -30, industrialCost: 96 } } },
  { id: "PRJ-015", name: "Airport Runway", delay: -28, industrialCost: 98, budget: "€234.5M", trend: "up", category: "Infraestruturas Aeroportos", region: "east", week: "week-1", weekData: { "week-1": { delay: -25, industrialCost: 97 }, "week-2": { delay: -28, industrialCost: 98 }, "week-3": { delay: -30, industrialCost: 99 }, "week-4": { delay: -35, industrialCost: 100 } } },
  { id: "PRJ-020", name: "Solar Farm", delay: -40, industrialCost: 90, budget: "€145.2M", trend: "up", category: "Power (energia)", region: "west", week: "week-4", weekData: { "week-1": { delay: -35, industrialCost: 88 }, "week-2": { delay: -38, industrialCost: 89 }, "week-3": { delay: -40, industrialCost: 90 }, "week-4": { delay: -42, industrialCost: 91 } } },

  // Quadrant 2: Delayed & High Cost (positive delay, >80% industrial cost)
  { id: "PRJ-003", name: "Skyline Plaza", delay: 32, industrialCost: 94, budget: "€156M", trend: "stable", category: "Construção Civil", region: "east", week: "week-1", weekData: { "week-1": { delay: 28, industrialCost: 92 }, "week-2": { delay: 31, industrialCost: 93 }, "week-3": { delay: 35, industrialCost: 95 }, "week-4": { delay: 38, industrialCost: 97 } } },
  ...
  { id: "PRJ-013", name: "Dam Construction", delay: 25, industrialCost: 96, budget: "€520M", trend: "stable", category: "Infraestruturas Hidráulicas", region: "north", week: "week-2", weekData: { "week-1": { delay: 20, industrialCost: 93 }, "week-2": { delay: 25, industrialCost: 96 }, "week-3": { delay: 28, industrialCost: 98 }, "week-4": { delay: 32, industrialCost: 99 } } },
  { id: "PRJ-019", name: "Oil Platform Construction", delay: 35, industrialCost: 91, budget: "€687.2M", trend: "stable", category: "Oil&Gas", region: "north", week: "week-1", weekData: { "week-1": { delay: 32, industrialCost: 89 }, "week-2": { delay: 35, industrialCost: 90 }, "week-3": { delay: 38, industrialCost: 92 }, "week-4": { delay: 40, industrialCost: 93 } } },
  ...
  { id: "PRJ-006", name: "Tech Campus", delay: -38, industrialCost: 65, budget: "€210M", trend: "stable", category: "Infraestruturas Urbanas", region: "south", week: "week-4", weekData: { "week-1": { delay: -35, industrialCost: 67 }, "week-2": { delay: -38, industrialCost: 66 }, "week-3": { delay: -40, industrialCost: 65 }, "week-4": { delay: -42, industrialCost: 63 } } },
...
export function EVMMatrix({ filterType, filterValue }: EVMMatrixProps) {
  ...
  const filteredProjects = (filterType && filterValue
    ...
    : filteredByCategory
  ).filter(p => p.industrialCost >= 60 && p.industrialCost <= 100) // Only show projects in 60-100% range
  ...
  const mapToPosition = (delay: number, industrialCost: number) => {
    ...
    // Map industrial cost (60-100%) to y position (0-100)
    const y = ((industrialCost - 60) / 40) * 100
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col justify-between h-[calc(100%-80px)]">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-orange-500 font-mono font-semibold">80%</span>
        </div>
        <div className="flex items-center gap-2">
