  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative w-[calc(100%-80px)] h-[calc(100%-80px)]">
        ...
        <div className="absolute -left-12 top-1/2 -translate-y-1/2 text-xs font-semibold text-warning flex items-center gap-1.5">
          <span>50%</span>
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col justify-between h-[calc(100%-80px)]">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-warning font-mono font-semibold">50%</span>
        </div>
        <div className="flex items-center gap-2">
      ...
      {/* Y-Axis Label */}
      <div className="absolute left-1.5 top-1/2 -translate-y-1/2 -translate-x-12 origin-center -rotate-90">
