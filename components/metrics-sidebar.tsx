      ...
      <div className="glass-card rounded-lg p-4 mt-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs text-muted-foreground">Avg. SPI</span>
            <span className="text-sm font-mono text-foreground">0.84</span>
          </div>
          <div className="w-full h-1.5 bg-secondary rounded-full overflow-hidden">
            <div className="h-full bg-cyan rounded-full" style={{ width: "94%" }} />
          </div>
